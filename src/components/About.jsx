  ...
  return (
    ...
    >
        ...
        <div className={`${layout.sectionInfo} mx-6`}>
            ...
            <h2 className={`font-poppins font-semibold xs:text-[48px] text-[40px] text-black xs:leading-[76.8px] leading-[66.8px] w-full`}>Bienvenue a<br className="block" /> l'Hotel du Phare</h2>
            <div className='mx-10'>
